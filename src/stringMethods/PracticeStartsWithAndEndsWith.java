...
public class PracticeStartsWithAndEndsWith {
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println((name.toUpperCase().startsWith("A") || name.startsWith("A")) ? ("You are in the club A") :("You are not in the club A"));

        System.out.println((name.toLowerCase().startsWith("a") || name.startsWith("A")) ? ("You are in the club A") :("You are not in the club A"));

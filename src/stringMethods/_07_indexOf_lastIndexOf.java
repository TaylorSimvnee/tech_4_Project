...
public class _07_indexOf_lastIndexOf {
    public static void main(String[] args) {
        ...
        /*
        Method: They are used to find the index or last index of some char or String values in another String
        ...
        NOTE: if the given char or String does nit exist, then they return -1
        NOTE: if you are looking for an index of String and it exists, it will return the first index of the found match
        ...
        sentence.indexOf("arizona"); // -1 --> it will always be -1 when it is not within the index
    }
}
